...
// class tour publically inherit travel class
...
//used to show the international tour packages
void india()
{
	int a;
	heading();
	...
	cout << "\t\t\t\t\t\t1.Ladakh Tour 6 Days 7 Nights (25,000/person)\n"
	     << endl;
	...
	case 1:
		amt = 25000;
		strcpy(str1, "Ladakh Tour 6 Days 7 Nights");
		break;
	case 2:
		amt = 20000;
